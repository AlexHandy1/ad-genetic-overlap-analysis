...
--dir /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_NO_APOE_MALES \
...
--target /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/Target_Data/Post_QC/ANM_3B_NO_APOE_MALES_ONLY \
--chr Chromosome \
--bp Position \
--snp  MarkerName \
--A1 Effect_allele \
...
--fastscore \
--out /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_NO_APOE_MALES/AD_PRS_NO_APOE_MALES
