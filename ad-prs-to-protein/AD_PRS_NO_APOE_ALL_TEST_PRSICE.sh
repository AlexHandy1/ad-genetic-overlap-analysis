...
Rscript /users/k1894983/Step3_AD_PRS/PRSice/PRSice.R \
--dir /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_NO_APOE_ALL_TEST_PRSICE \
--prsice /users/k1894983/Step3_AD_PRS/PRSice/bin/PRSice \
--base /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/Base_Data/Post_QC/Kunkle_Stage1_post_qc.txt \
--target /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/Target_Data/Post_QC/ANM_3B_NO_APOE \
--chr Chromosome \
--bp Position \
--snp  MarkerName \
--A1 Effect_allele \
...
--fastscore \
--out /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_NO_APOE_ALL/AD_PRS_NO_APOE_ALL_TEST_PRSICE
