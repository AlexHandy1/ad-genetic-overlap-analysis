...
--dir /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_WITH_APOE_ALL_COV \
...
--target /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/Target_Data/Post_QC/ANM_3B_WITH_APOE \
--chr Chromosome \
--bp Position \
--snp  MarkerName \
--A1 Effect_allele \
...
--cov-file /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/Target_Data/Post_QC/ANM_Proteins_Covariate_File.txt \
--cov-col AD \
--bar-levels 5e-8,5e-5,5e-4,0.001,0.01,0.05,0.1,0.2,0.5,1 \
--fastscore \
--out /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_WITH_APOE_ALL_COV/AD_PRS_WITH_APOE_ALL_COV
