...
AGES=( 65_AND_OVER 70_AND_OVER 75_AND_OVER 80_AND_OVER)
...
--dir /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_WITH_APOE_$AGE \
...
--target /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/Target_Data/Post_QC/ANM_3B_WITH_APOE_$AGE \
--chr Chromosome \
--bp Position \
--snp  MarkerName \
--A1 Effect_allele \
...
--fastscore \
--out /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_WITH_APOE_$AGE/AD_PRS_WITH_APOE_$AGE
done
