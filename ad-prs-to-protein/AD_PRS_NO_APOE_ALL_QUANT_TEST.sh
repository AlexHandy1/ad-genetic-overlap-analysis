...
--dir /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_NO_APOE_ALL_QUANT_TEST \
...
--fastscore \
--quantile 10 \
--out /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/AD_PRS_NO_APOE_ALL_QUANT_TEST/AD_PRS_NO_APOE_ALL_QUANT_TEST
