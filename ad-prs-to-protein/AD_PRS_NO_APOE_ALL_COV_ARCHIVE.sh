...
--dir /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/PRS_Outputs_ANM_NO_APOE \
...
--fastscore \
--out /mnt/lustre/groups/proitsi/Alex/AD_PRS_to_Protein/PRS_Outputs/PRS_Outputs_ANM_NO_APOE/Kunkle_AD_to_ANM_NO_APOE
