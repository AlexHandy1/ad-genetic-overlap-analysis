...
files <- c("protein_prs_all_with_apoe_meta_analysis_res.csv", "protein_prs_all_no_apoe_meta_analysis_res.csv", "protein_prs_Males_with_apoe_meta_analysis_res.csv", "protein_prs_Males_no_apoe_meta_analysis_res.csv", "protein_prs_Females_with_apoe_meta_analysis_res.csv", "protein_prs_Females_no_apoe_meta_analysis_res.csv", "protein_prs_70.And.Over_with_apoe_meta_analysis_res.csv", "protein_prs_70.And.Over_no_apoe_meta_analysis_res.csv")
...
for (file in files) {
	...
	res <- res %>% group_by(Protein) %>% filter(p == min(p)) %>% select(Protein, Threshold, r2, p)
