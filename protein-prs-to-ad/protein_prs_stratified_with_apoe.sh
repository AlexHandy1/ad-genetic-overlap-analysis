...
do
   ...
   do
      ...
      STRATS=( Males Females 65.And.Over 70.And.Over 75.And.Over 80.And.Over )
      ...
      do
         ...
         TARGET_FILE="/mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Target_Data/${SAMPLE}_ForPRS.WITHAPOE.Original.Overlapping.${STRAT}"
         echo $TARGET_FILE
         ...
         OUTPUT="${PROTEIN_NAME%????}_${SAMPLE}_${STRAT}"
         echo $OUTPUT
         ...
         --dir /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_stratified_with_apoe \
         ...
         --quantile 10 \
         --fastscore \
         --out /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_stratified_with_apoe/$OUTPUT
      done
   done
done
