...
do
   ...
   do
      ...
      --dir /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_all_no_apoe \
      ...
      --quantile 10 \
      --fastscore \
      --out /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_all_no_apoe/$OUTPUT
   done
done
