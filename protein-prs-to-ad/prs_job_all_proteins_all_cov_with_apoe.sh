...
do
   ...
   do
      ...
      TARGET_FILE="/mnt/lustre/groups/proitsi/Alex/Target_Data/${SAMPLE}_ForPRS.WITHAPOE.Original.Overlapping"
      echo $TARGET_FILE
      ...
      --dir /mnt/lustre/groups/proitsi/Alex/PRS_Outputs/PRS_Outputs_All_Covariates_WITH_APOE \
      ...
      --fastscore \
      --out /mnt/lustre/groups/proitsi/Alex/PRS_Outputs/PRS_Outputs_All_Covariates_WITH_APOE/$OUTPUT
   done
done
