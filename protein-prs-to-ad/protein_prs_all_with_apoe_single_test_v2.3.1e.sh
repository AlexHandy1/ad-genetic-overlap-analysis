...
do
   ...
   --dir /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_all_with_apoe_test_prev \
   ...
   --quantile 10 \
   --fastscore \
   --out /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_all_with_apoe_test_prev/$OUTPUT
done
