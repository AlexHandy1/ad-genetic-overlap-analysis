...
do
   ...
   do
      ...
      do
         ...
         TARGET_FILE="/mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Target_Data/${SAMPLE}_ForPRS.NOAPOE.Original.Overlapping.${STRAT}"
         echo $TARGET_FILE
         ...
         --dir /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_stratified_no_apoe \
         ...
         --quantile 10 \
         --fastscore \
         --out /mnt/lustre/groups/proitsi/Alex/Protein_PRS_to_AD/Results/prs/protein_prs_stratified_no_apoe/$OUTPUT
      done
   done
done
